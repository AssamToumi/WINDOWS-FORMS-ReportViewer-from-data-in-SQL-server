...
namespace SQL_Report.BikeStoresDataSetTableAdapters {
...
SELECT customer_id, first_name, last_name, phone, email, street, city, state, zip_code FROM sales.customers WHERE (customer_id = @customer_id)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::SQL_Report.Properties.Settings.Default.BikeStoresConnectionString;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].Parameters.Add(new global::System.Data.SqlClient.SqlParameter("@state", global::System.Data.SqlDbType.VarChar, 25, global::System.Data.ParameterDirection.Input, 0, 0, "state", global::System.Data.DataRowVersion.Current, false, null, "", "", ""));
        }
        ...
        public virtual int Fill(BikeStoresDataSet.customersDataTable dataTable, string state) {
        ...
        public virtual BikeStoresDataSet.customersDataTable GetData(string state) {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            if ((state == null)) {
                this.Adapter.SelectCommand.Parameters[0].Value = global::System.DBNull.Value;
            }
