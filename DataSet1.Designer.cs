...
namespace SQL_Report.DataSet1TableAdapters {
...
SELECT customer_id, first_name, last_name, phone, email, street, city, state, zip_code FROM sales.customers WHERE (customer_id = @customer_id)";
        ...
        public virtual int Fill(DataSet1.customersDataTable dataTable, string state) {
        ...
        public virtual DataSet1.customersDataTable GetData(string state) {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            if ((state == null)) {
                this.Adapter.SelectCommand.Parameters[0].Value = global::System.DBNull.Value;
            }
